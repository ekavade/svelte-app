<!-- <script>
	...
	async function getData() {
		...
		const records = await client.records.getFullList('videos', 200 /* batch size */, {
			sort: '-created'
		});
		return records;
	}
				...
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light">
						<a class="navbar-brand" href="/">
							<img class="img-fluid logo" src="images/logo-1.png" alt="streamlab" />
						</a>
							...
							<div id="gen-menu-contain" class="gen-menu-contain">
								<ul id="gen-main-menu" class="navbar-nav ml-auto">
									<li class="menu-item active">
										...
										<i class="fa fa-chevron-down gen-submenu-icon" />
										<ul class="sub-menu">
											<li class="menu-item active">
						...
						<div class="gen-header-info-box">
							<div class="gen-menu-search-block">
								<a href="javascript:void(0)" id="gen-seacrh-btn"><i class="fa fa-search" /></a>
								<div class="gen-search-form">
									<form role="search" method="get" class="search-form" action="#">
										...
										<button type="submit" class="search-submit"
											><span class="screen-reader-text" /></button
										>
									</form>
								</div>
							</div>
							<div class="gen-account-holder">
								<a href="javascript:void(0)" id="gen-user-btn"><i class="fa fa-user" /></a>
							...
							<div class="gen-btn-container">
								<a href="register.html" class="gen-button">
									<div class="gen-button-block">
										<span class="gen-button-line-left" />
										...
										<div class="col-xl-6">
											...
											<div class="gen-movie-meta-holder">
												<ul class="gen-meta-after-title">
													...
													<li>
														<img src="images/asset-2.png" alt="rating" />
														<span> 0 </span>
													</li>
												</ul>
												<p>
													Streamlab is a long established fact that a reader will be distracted by
												...
												<ul class="menu bottomRight">
													<li class="share top">
														...
														<ul class="submenu">
															...
															<li>
																<a href="/" class="facebook"><i class="fab fa-instagram" /></a>
															</li>
															<li><a href="/" class="facebook"><i class="fab fa-twitter" /></a></li>
														</ul>
													</li>
												</ul>
														...
														<div class="mCustomScrollBox">
															<div class="mCSB_container">
																<a class="login-link" href="register.html"
																	>Sign in to add this movie to a playlist.</a
																>
															</div>
														</div>
													</div>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">machine war</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>1h 22mins</li>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">the horse lady</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>1hr 24 mins</li>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">Rebuneka the doll</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>1hr 44 mins</li>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">the giant ship</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>1h 02 mins</li>
			...
			<div class="col-12">
				<div class="gen-style-2">
					...
					>
						...
						<div class="item">
							<div
								class="movie type-movie status-publish has-post-thumbnail hentry movie_genre-action"
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										<div class="gen-movie-img">
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">dream of dragons</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>1 Season</li>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">3 Hackers:TBG</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>1 Season</li>
													...
													<div class="gen-movie-action">
														<div class="gen-btn-container button-1">
															<a class="gen-button" href="/" tabindex="0">
																<i aria-hidden="true" class="ion ion-play" />
																<span class="text">Play Now</span>
															</a>
														</div>
													</div>
								...
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										<div class="gen-movie-img">
											...
											<div class="gen-movie-add">
												<div class="movie-actions--link_add-to-playlist dropdown">
													<a class="dropdown-toggle" href="/"><i class="fa fa-plus" /></a>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">skull of myths</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>1hr 24mins</li>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">war of rejonse</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>2hr 20mins</li>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">the big sick</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>2hr 00mins</li>
							...
							>
								<div class="gen-carousel-movies-style-2 movie-grid style-2">
									<div class="gen-movie-contain">
										...
										<div class="gen-info-contain">
											<div class="gen-movie-info">
												<h3><a href="single-movie.html">bad genius</a></h3>
											</div>
											<div class="gen-movie-meta-holder">
												<ul>
													<li>2hr 10mins</li>
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<ul class="social-link">
										...
										<li><a href="/" class="facebook"><i class="fab fa-instagram" /></a></li>
										<li><a href="/" class="facebook"><i class="fab fa-skype" /></a></li>
										<li><a href="/" class="facebook"><i class="fab fa-twitter" /></a></li>
									</ul>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-md-12 align-self-center">
						<span class="gen-copyright"
							><a target="_blank" href="/"> Copyright 2021 stremlab All Rights Reserved.</a></span
						>
					</div>
				</div>
			</div>
...
<!-- Back-to-Top start -->
<div id="back-to-top">
	<a class="top" id="top" href="#top"> <i class="ion-ios-arrow-up" /> </a>
</div>
<!-- Back-to-Top end -->
